...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color: #fff">
    ...
    <ul class="nav navbar-right top-nav" style="background-color: black">
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><!--<i class="fa fa-user"></i>--> <b>ADMIN LOGIN</b> <!--<b class="caret"></b>--></a>
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-envelope"></i> <?php echo $userEmail;?> <b class="caret"></b></a>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse" >
        <ul class="nav navbar-nav side-nav">
            <li class="active">
                <a href="<?php echo \Cake\Routing\Router::Url('/users/profile_account');?>"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
            </li>
            <!--<li>
            ...
            <li>
                <a href="<?php echo \Cake\Routing\Router::Url('/profiles/my_profile/');?><?php echo $ProfileId;?>"><i class="fa fa-fw fa-user"></i> My Profile</a>                       
            </li>
