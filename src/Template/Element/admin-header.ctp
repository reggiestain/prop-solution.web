                    ...
                    <div class="col-lg-12">
                        <div class="collapse navbar-collapse">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                -->
                                <li>                                
                                    <a href="#">Reminders <i class="fa fa-bell"></i></a>
                                </li>
                                <li>
                                    <a href="#">Settings <i class="fa fa-cog"></i></a>
                                </li>
                                <li>
                                    <a href="#">Go to frontend <i class="fa fa-share-alt"></i></a>
                                </li>
                                <li class="dropdown">
                                    <a href="#" role="button" class="dropdown-toggle" data-hover="dropdown"> <i class="fa fa-user"></i> <?php echo $user->email;?> <i class="caret"></i></a>
