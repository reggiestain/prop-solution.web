...
return [
    ...
    'EmailTransport' => [
        ...
        'gmail' => [
            'className' => 'Smtp',
            // The following keys are used in SMTP transports
            'host' => 'smtp.test11.finedemo.co.za',
            'port' =>   587,
            //'timeout' => 60,
            'username' => 'proquest@test11.finedemo.co.za',
            'password' => 'REGinald19#',
           // 'client' => null,
          //'tls' => n        
      ...
      'gmails' => [
            // The following keys are used in SMTP transports
            'host' => 'gandolfini.aserv.co.za',
            'port' => 465,
            //'timeout' => 60,
            'username' => 'admin@proquest.co.za',
            'password' => 'proquest19#',
            'className' => 'Smtp',
          //'tls' => n                
      ],  
    ...
    'Datasources' => [
        'default' => [
            ...
            'username' => 'testfavgcw_1',
            'password' => 'uXUGnKYJQ18',
            'database' => 'proquest',
            'encoding' => 'utf8',
            'timezone' => '',
            'cacheMetadata' => false,
